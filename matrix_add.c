...
double matrix_matrix_add_int8(size, threads)
{
    int i;
...
double matrix_matrix_add_int16(size, threads)
{
    int i;
    int size2D=size*size;
    srand(SEED);
...
double matrix_matrix_add_int32(size, threads)
{
    int i;
    int size2D=size*size;
    srand(SEED);
...
double matrix_matrix_add_spfp(size, threads)
{
    int i;
    int size2D=size*size;
    srand(SEED);
...
double matrix_matrix_add_dpfp(size, threads)
{
    int i;
    int size2D=size*size;
    srand(SEED);
